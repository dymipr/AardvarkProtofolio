...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Adam Baze"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Adam Baze</td></tr>
  ...
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="Adam Baze Facial Recognition">
  ...
  },
  {
    ...
    html: `
			<div class="finland-map-wrap">
				<img class="finland-map" src="${imagePath}/world-map.svg" alt="World Map">
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Adam" -lastName "Baze"',
        typing: true,
      },
      {
        text: "loading...",
